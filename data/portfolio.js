...
export const mainlandContent = [
  {
    id: 59,
    imgSrc: "/assets/images/demo-strong/portfolio/1.jpg",
    imgAlt: "Mainland Business Setup in the UAE",
    title: "Mainland Business Setup in the UAE",
    description: "The power of local expertise helps you navigate UAE mainland licensing with ease and unlock boundless business potential.",
  },
  {
    id: 60,
    imgSrc: "/assets/images/demo-strong/portfolio/2.jpg",
    imgAlt: "Mainland Business Setup in Abu Dhabi",
    title: "Mainland Business Setup in Abu Dhabi",
    description: "The capital advantage: Set up in Abu Dhabi mainland with expert local support to maximise growth and compliance.",
  },
  {
    id: 61,
    imgSrc: "/assets/images/demo-strong/portfolio/3.jpg",
    imgAlt: "Mainland Business Setup in Ajman",
    title: "Mainland Business Setup in Ajman",
    description: "The Ajman Advantage: Launch your business in Ajman Mainland with expert support for fast, cost-efficient, and compliant company formation.",
  },
  {
    id: 62,
    imgSrc: "/assets/images/demo-strong/portfolio/4.jpg",
    imgAlt: "Mainland Business Setup in Sharjah",
    title: "Mainland Business Setup in Sharjah",
    description: "The Sharjah Strength: Build your business in Sharjah Mainland with expert-led guidance, seamless approvals, and cost-effective licensing.",
  },
];
...
export const freezoneContent = [
  {
    id: 59,
    imgSrc: "/assets/images/demo-strong/portfolio/1.jpg",
    imgAlt: "Freezone Business Setup in the UAE",
    title: "Freezone Business Setup in the UAE",
    description: "Build your business in UAE Free Zones with expert-led setup, quick approvals, and 100% foreign ownership.",
  },
  {
    id: 60,
    imgSrc: "/assets/images/demo-strong/portfolio/2.jpg",
    imgAlt: "Freezone Business Setup in Abu Dhabi",
    title: "Freezone Business Setup in Abu Dhabi",
    description: "Launch your business in Abu Dhabi free zones—offering 100% foreign ownership, diverse activities, global market access, and a streamlined setup in a strategic UAE location.",
  },
  {
    id: 61,
    imgSrc: "/assets/images/demo-strong/portfolio/3.jpg",
    imgAlt: "Freezone Business Setup in Ajman",
    title: "Freezone Business Setup in Ajman",
    description: "Ajman Free Zone business setup is one of the easiest and most cost-effective ways to launch your company.",
  },
  {
    id: 62,
    imgSrc: "/assets/images/demo-strong/portfolio/4.jpg",
    imgAlt: "Freezone Business Setup in Sharjah",
    title: "Freezone Business Setup in Sharjah",
    description: "Establish your business in Sharjah Free Zones with full foreign ownership, flexible licensing solutions, and access to cost-effective infrastructure—ideal for SMEs and international firms expanding into the UAE.",
  },
  {
    id: 63,
    imgSrc: "/assets/images/demo-strong/portfolio/5.jpg",
    imgAlt: "Freezone Business Setup in Ras Al Khaimah",
    title: "Freezone Business Setup in Ras Al Khaimah",
    description: "Start your business in Ras Al Khaimah free zones with 100% foreign ownership, cost-effective licenses, and easy access to regional and global markets from a prime UAE location.",
  },
  {
    id: 64,
    imgSrc: "/assets/images/demo-strong/portfolio/6.jpg",
    imgAlt: "Freezone Business Setup with IFZA",
    title: "Freezone Business Setup with IFZA",
    description: "Launch your business with IFZA—one of the UAE’s most cost-effective and flexible free zones offering 100% foreign ownership, wide-ranging activities, and simplified regulations.",
  },
];
