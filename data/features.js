...
export const featuresData = [
  {
    ...
    title1: "Transparent",
    title2: "Pricing",
    desc: `We offer clear, upfront pricing tailored to your business needs. No surprises—just honest, reliable guidance you can trust.`,
    iconPath:
  ...
  },
  {
    ...
    title1: "Deep UAE",
    title2: "Expertise",
    desc: `With over 13 years of experience and thousands of companies successfully formed, we understand every step of UAE business law and compliance.`,
    iconPath:
  ...
  },
  {
    ...
    desc: `From visas and PRO services to banking and office space, UBIXO handles it all—so you can focus on growing your business.`,
    iconPath:
  ...
  },
  {
    ...
    number: "04",
    title1: "Reliable",
    title2: "Local Sponsorship",
    desc: `We provide trusted local sponsorship without interference in your operations—ideal for investors who want full control with local support.`,
    iconPath:
...
export const featuresListData = [
  ...
  { text: "Mainland Company" },
  { text: "Free Zone Setup" },
  { text: "Offshore Business" },
  { text: "Golden Visa Support" },
];