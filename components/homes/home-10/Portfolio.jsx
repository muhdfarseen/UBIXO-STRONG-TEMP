    ...
    <div className="container">
      <div className="row mb-90 mb-sm-50">
        <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
          <h2 className="section-caption-border">OUR PACKAGES</h2>
          <h3 className="section-title-strong mb-40">
            Business setup <br />
            <span className="font-alt"> made </span> simple
          </h3>
          <p className="mb-0">
            Choose from flexible, scalable administrative support packages
            designed for startups, SMEs, and large corporations. Whether you
            need help with licensing, visas, documentation, or full compliance
            support, UBIXO has a package that fits your business size and needs.
            <br /> <br />
            Get licensed, compliant, and operational in just a few days with
            UBIXO's expert support.
          </p>
        </div>
      </div>
      {/* Portfolio Carousel */}
