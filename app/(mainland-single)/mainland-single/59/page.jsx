                  ...
                  <h1 className="hs-title-7 mb-0">
                    <span className="wow charsAnimIn-2" data-splitting="chars">
                      ...
                      <span className="font-alt">
                        <AnimatedText text={"Business Setup in the UAE"} />
                      </span>
                    </span>
                  </h1>
                </div>
                ...
                <div className="container relative">
                  <div className="row mb-sm-20">
                    <h2 className="h3 font-alt mb-20">
                      The power of local expertise helps you navigate UAE
                      mainland licensing with ease and unlock boundless business
                      potential.
                    </h2>
                    <p className="mb-0">
